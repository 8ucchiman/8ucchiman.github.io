  ...
  <div class="container">
    ...
    <div class="contact-links">
      ...
      <a class="icon-link" href="{li}" target="_blank" rel="noreferrer">
        <svg class="icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M4 3h16a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm3.5 6H6V18h1.5V9Zm.73-2.75a1.24 1.24 0 1 0 0-2.48 1.24 1.24 0 0 0 0 2.48ZM18 18h-1.5v-4.75c0-1.52-.54-2.38-1.74-2.38-.95 0-1.51.64-1.76 1.26-.09.2-.11.47-.11.74V18H11.4s.02-7.93 0-8.75H13v1.24c.2-.63 1.28-1.46 2.98-1.46 2.02 0 3.02 1.28 3.02 3.89V18Z"/></svg>
      </a>
